 ...
 */
public class NetFileChecker {

	private static final Logger log = LoggerFactory.getLogger(NetFileChecker.class);
	...
	private static boolean compareContent(String url, String filePathName) {
		...
		try {
			...
			log.error("compareContent:" + e.getMessage(), e);
		} finally {
