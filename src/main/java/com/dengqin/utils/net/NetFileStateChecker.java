...
import com.dengqin.utils.base.IntUtil;
import com.dengqin.utils.base.LongUtil;
 ...
 */
public class NetFileStateChecker {

	protected static final Logger log = LoggerFactory.getLogger(NetFileStateChecker.class);
