 ...
 * 
 * @see <a href=
 *      'https://www.owasp.org/index.php/XSS_Filter_Evasion_Cheat_Sheet'>XSS_Filter_Evasion_Cheat_Sheet</a>
 */
public class XssUtil {
	 ...
	 * XSS漏洞利用的特征词
	 */
	static private final String[] XSS_TAG_STRINGS = new String[] { "</script>", "<script", "src=", "eval(",
			"expression(", "javascript:", "vbscript:", "onload=", "&#", // &#0000106
																		// ,
																		// &#106;
																		// ...
	 ...
	 * XSS漏洞辅助特征字符
	 */
	static private final String[] XSS_URL_STRINGS = new String[] { "%00" };

	/**
	 * 需要进行
	 */
	static private final List<String> STRICT_PARAMS = Arrays.asList(new String[] { "callback", "jsonpcallback", });
	...
	private static void strictXSScheck(String key, String value) {
		...
		if (value.matches(regex) == false) {
			throw new XssInvalidException(
					"key:" + key + " value:" + value + " strictCheck:no group by [a-z][A-Z][0-9]_");
		}
	}
