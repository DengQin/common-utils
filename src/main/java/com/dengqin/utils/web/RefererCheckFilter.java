...
<filter>
    ...
    <filter-class>com.dengqin.utils.web.RefererCheckFilter</filter-class>
    <!-- host白名单,多个以","隔开 -->
    <init-param>
        <param-name>hostWhiteList</param-name>
        <param-value>sz.aaaa.com,udb.bbb.com,ccc.com,ddd.ggg.com,zadan.ddd.com</param-value>
    </init-param>
    <!-- 忽略接口 -->
    <init-param>
...
//        String host = parseHost("http://abc.test.com/play/awardInfo.do") ;
//        HOST_WHITELIST.add("*.test.com") ;
//    }
}
